          ...
          <div>
            ...
            {showNoticeForm && (
              <div className="form-box">
                ...
                <label>
                  <input type="checkbox" value="student" onChange={handleAudienceChange}/>
                  Student
                </label>

                <label>
                  <input type="checkbox" value="faculty" onChange={handleAudienceChange}/>
                  Faculty
                </label>
